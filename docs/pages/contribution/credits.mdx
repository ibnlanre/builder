...
The concept of a "Module Cache Key" is credited to [Alvin Huang][github], who wrote the first prototype in a [TypeScript playground][playground] and introduced it in the comment section of the blog post, [Effective React Query Keys][react-query] by [TKDodo][twitter]. The "Key Factory" pattern was later refined and developed into the `@ibnlanre/builder` package.
