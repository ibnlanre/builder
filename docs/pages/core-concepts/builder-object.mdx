...
The `builder` object is a tree-like structure that provides mechanisms for accessing the keys and values of a [register][4]. It is created from a [register][4] using the [createBuilder][2] function, and serves as the main interface for querying the [register][4].
